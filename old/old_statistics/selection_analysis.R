...
## plot
plot(perf,lwd = 3,cex=1.4, main="mouse CEBPA prediction")
# calculate AUC
...
#####** deltaSVM summary **#####
deltaSVMcons<-fread(paste0(pathResults, "mouse/CEBPA_conserved_deltaSVM.txt"))
deltaSVMgain<-fread(paste0(pathResults, "mouse/CEBPA_specific_gain_deltaSVM.txt"))
deltaSVMloss<-fread(paste0(pathResults, "mouse/CEBPA_specific_loss_deltaSVM.txt"))
...
deltaSVMloss$pValue = 1-deltaSVMloss$pValue #lower tail test
...
perf <- performance( pred, "tpr", "fpr" )
## plot
plot(perf,lwd = 3,cex=1.4, main="human CEBPA prediction")
# calculate AUC
auc_result <-performance( pred, measure = "auc")
unlist(slot(auc_result, "y.values"))
...
#####** deltaSVM summary **#####
deltaSVM<-fread(paste0(pathData, "data/human/deltaSVM/CEBPA/deltaSVM_highertailTest.txt"))
## change the format of deltaSVM files

deltaSVM<-dataMod(deltaSVM)
#deltaSVM2<-dataMod(deltaSVM2)
...
perf <- performance( pred, "tpr", "fpr" )
## plot
plot(perf,lwd = 3,cex=1.4, main="fly CTCF prediction")
# calculate AUC
auc_result <-performance( pred, measure = "auc")
unlist(slot(auc_result, "y.values"))
...
#####*** deltaSVM summary ***#####
deltaSVMcons<-fread(paste0(pathResults, "fly/CTCF_conserved_deltaSVM.txt"))
deltaSVMgain<-fread(paste0(pathResults, "fly/CTCF_specific_gain_deltaSVM.txt"))
deltaSVMloss<-fread(paste0(pathResults, "fly/CTCF_specific_loss_deltaSVM.txt"))
## change the format of deltaSVM files
deltaSVMcons<-dataMod(deltaSVMcons)
deltaSVMgain<-dataMod(deltaSVMgain)
deltaSVMloss<-dataMod(deltaSVMloss)
...
perf <- performance( pred, "tpr", "fpr" )
## plot
plot(perf,lwd = 3,cex=1.4, main="human CTCF prediction")
# calculate AUC
auc_result <-performance( pred, measure = "auc")
unlist(slot(auc_result, "y.values"))
...
#####*** deltaSVM summary ***#####
deltaSVM<-fread(paste0(pathResults, "/human/CTCF_deltaSVM.txt"))
deltaSVM<-dataMod(deltaSVM)
## plot deltaSVM and pvalue
par(mfrow=c(1,2))
par(mar=c(7,5,4,2))
...
plot(c(1:29),organSub$numb, ylab="Average number of substitutions  \n Non-positive sites", main="Human CTCF binding sites",xlab="",
     pch=16,cex=2,xaxt="n",col=plotColor,cex.lab=1.5,cex.main=1.5, cex.axis=1.5, type="p", ylim=c(0.013,0.014))

legend("topright",legend=plotLegend,col = unique(rev(plotColor)),cex=0.9,
       pch=rep(16,times=10),pt.cex=2,bty="n",inset=c(-0.51,0),xpd = TRUE)
abline(v=c(1:29),col="grey", lty=4)
axis(side = 1, at = c(1:29), labels=F)
text(c(1:29), 0.0129, srt = 45,cex=1, adj = 1,labels = organSub$organ, xpd = TRUE)
...
perf <- performance( pred, "tpr", "fpr" )
## plot
plot(perf,lwd = 3,cex=1.4, main="mouse CTCF prediction")
# calculate AUC
auc_result <-performance( pred, measure = "auc")
unlist(slot(auc_result, "y.values"))
...
#####*** deltaSVM summary ***#####
deltaSVM<-fread(paste0(pathResults, "mouse/CTCF_deltaSVM.txt"))
deltaSVM<-dataMod(deltaSVM)
...
system <- c("Immune system", "Nervous system", "Nervous system", "Cardiovascular system",
            "Excretory system", "Endocrine system", "Respiratory system", "Nervous system", 
            "Digestive system", "Male reproductive system", "Immune system")

uniq_system <- c("Immune system", "Nervous system", "Cardiovascular system", 
                 "Excretory system","Endocrine system", "Respiratory system", 
                 "Digestive system", "Male reproductive system") 

col <- c(pal[10], pal[1], pal[7], "blue", pal[9], pal[8], pal[4],  pal[5])
names(col) <- uniq_system
...
plot(c(1:11),organProp$prop, ylab="Proportion of positive binding sites", main="Mouse CTCF binding sites",xlab="", pch=16,cex=2,
     xaxt="n", type="p",col=col[organProp$system],cex.lab=1.5,cex.main=1.5, cex.axis=1.5, ylim=c(0.01,0.02))
legend("topright",legend=uniq_system, col = col,cex=1,
       pch=rep(16,times=11),pt.cex=2,bty="n",inset=c(-0.4,0),xpd = TRUE)
abline(v=c(1:11),col="grey", lty=4)
axis(side = 1, at = c(1:11), labels=F)
text(c(1:11), 0.009, srt = 45, cex=1.3,adj = 1,labels = organProp$organ, xpd = TRUE)
...
plot(c(1:11),organSub$numb, ylab="Average number of substitutions  \n Non-positive sites", main="Mouse CTCF binding sites",xlab="",
     pch=16,cex=2,xaxt="n",cex.lab=1.5,cex.main=1.5, cex.axis=1.5, type="p",ylim=c(0.01,0.014),col=plotColor)

legend("topright",legend=plotLegend,col = unique(rev(plotColor)),cex=1,
       pch=rep(16,times=10),pt.cex=2,bty="n",inset=c(-0.52,0),xpd = TRUE)
abline(v=c(1:11),col="grey", lty=4)
axis(side = 1, at = c(1:11), labels=F)
