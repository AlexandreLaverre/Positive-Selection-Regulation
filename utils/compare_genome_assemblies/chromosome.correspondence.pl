...
sub printHelp{
    ...
    print "\n";
    print "This script checks if two genome assemblies are identical.\n";
    print "\n";
...
$parameters{"pathAssembly1"}="NA";
$parameters{"pathAssembly2"}="NA";
$parameters{"pathOutput"}="NA";

my @defaultpars=("pathAssembly1","pathAssembly2","pathOutput");
my %defaultvalues;
...
my %ensembl;
readFasta($parameters{"pathAssembly1"}, \%ensembl);

my $nbens=keys %ensembl;

print "Found ".$nbens." chromosomes in assembly 1.\n";

my %ucsc;
readFasta($parameters{"pathAssembly2"}, \%ucsc);

my $nbucsc=keys %ucsc;

print "Found ".$nbucsc." chromosomes in assembly 2.\n";
...
print $output "Assembly1\tAssembly2\tSize\n";
