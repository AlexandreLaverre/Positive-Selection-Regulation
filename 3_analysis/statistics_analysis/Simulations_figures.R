...
bin = "exact_ranked_50"
data = "beta_0.0Null_25Stab_25Pos"
...
for (sel in selection){
  ...
  simul <- cbind(simul, permut[,c("pval.high", "signif", "signif.bin", "pval.two.tailed")])
...
pdf(paste0(pathFigure, "Simulation_", sp, "_", simp_TF, "_",  data, "_", bin, "", ".pdf"), width=10, height=6)
par(xpd = TRUE)
