...
sp = "drosophila"
TF = "modERN/tai_tai-GFP_wanderingthirdinstarlarva_1" #c("Wilson/CEBPA", "Wilson/HNF6", "Wilson/HNF4A", "Wilson/FOXA1") #, "Schmidt12/CTCF")
method = ifelse(sp=="human", "exact_ranked_ancestral", "exact_ranked_ancestral")
cutoff = 2
...
print(TF)
file = paste0(path, "positive_selection/NarrowPeaks/", sp, "/", TF, "/Tests/PosSelTest_deltaSVM_10000permutations_two_tailed_ancestral.txt")
